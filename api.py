...
try:
    ...
    from investing_datafeed import InvestingDatafeed as TvDatafeed, Interval
...
#  -----------------------------------------------
def ohlcv(tv:TvDatafeed, symbol:str="8830", exchange:str="COMEX", interval:Interval=Interval.in_1_minute, n_bars:int=9) -> str:
    try:
...
# ------------------------------------------------
def emas954(tv:TvDatafeed, symbol:str="8830", exchange:str="COMEX", interval:Interval=Interval.in_1_minute, n_bars:int=9) -> str:
    try:
        df = tv.get_hist(symbol=symbol, exchange=exchange, interval=interval, n_bars=n_bars)
...
def main():
    ...
    def ohlcv_1m():
        try:
            return ohlcv(tv=tv,symbol=SYMBOL, exchange=EXCHANGE, interval=Interval.in_1_minute)
        except Exception as e:
    ...
    def ohlcv_5m():
        try:
            return ohlcv(tv=tv,symbol=SYMBOL, exchange=EXCHANGE, interval=Interval.in_5_minute)
        except Exception as e:
    ...
    def ohlcv_15m():
        try:
            return ohlcv(tv=tv,symbol=SYMBOL, exchange=EXCHANGE, interval=Interval.in_15_minute)
        except Exception as e:
    ...
    def ohlcv_1h():
        try:
            return ohlcv(tv=tv,symbol=SYMBOL, exchange=EXCHANGE, interval=Interval.in_1_hour, n_bars=99)
        except Exception as e:
    ...
    def ohlcv_4h():
        try:
            return ohlcv(tv=tv, symbol=SYMBOL, exchange=EXCHANGE, interval=Interval.in_4_hour, n_bars=99)
        except Exception as e:
    ...
    def ohlcv_d():
        try:
            return ohlcv(tv=tv, symbol=SYMBOL, exchange=EXCHANGE, interval=Interval.in_daily, n_bars=99)
        except Exception as e:
    ...
    def ohlcv_w():
        try:
            return ohlcv(tv=tv, symbol=SYMBOL, exchange=EXCHANGE, interval=Interval.in_weekly, n_bars=99)
        except Exception as e:
    ...
    def emas954_w():
        try:
            return emas954(tv=tv, symbol=SYMBOL, exchange=EXCHANGE, interval=Interval.in_weekly, n_bars=5000)
        except Exception as e:
    ...
    def emas954_d():
        try:
            return emas954(tv=tv, symbol=SYMBOL, exchange=EXCHANGE, interval=Interval.in_daily, n_bars=5000)
        except Exception as e:
    ...
    def emas954_4h():
        try:
            return emas954(tv=tv, symbol=SYMBOL, exchange=EXCHANGE, interval=Interval.in_4_hour, n_bars=5000)
        except Exception as e:
    ...
    def emas954_1h():
        try:
            return emas954(tv=tv, symbol=SYMBOL, exchange=EXCHANGE, interval=Interval.in_1_hour, n_bars=5000)
        except Exception as e:
    ...
    def emas954_15m():
        try:
            return emas954(tv=tv, symbol=SYMBOL, exchange=EXCHANGE, interval=Interval.in_15_minute, n_bars=5000)
        except Exception as e:
    ...
    def emas954_5m():
        try:
            return emas954(tv=tv, symbol=SYMBOL, exchange=EXCHANGE, interval=Interval.in_5_minute, n_bars=5000)
        except Exception as e:
    ...
    def emas954_1m():
        try:
            return emas954(tv=tv, symbol=SYMBOL, exchange=EXCHANGE, interval=Interval.in_1_minute, n_bars=5000)
        except Exception as e:
...
if __name__ == "__main__":
    ...
    try:
        tv = TvDatafeed()
        logger.info("Sesión de TvDatafeed (Investing) iniciada correctamente")
    except Exception as e:
